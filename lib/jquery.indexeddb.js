(function($, undefined) {
    ...
    if (navigator.userAgent.match(/Android/i) && (version.indexOf("4.3") > -1 || version.indexOf("4.2") > -1 || version.indexOf("4.1") > -1)) {
        ...
        try {
            ...
            IDBKeyRange = window.IDBKeyRange || window.webkitIDBKeyRange || idbModules.IDBKeyRange;
            IDBCursor = window.IDBCursor || window.webkitIDBCursor || idbModules.IDBCursor || {};
        }
        catch (e) {
            indexedDB = window.shimIndexedDB;
            IDBKeyRange = idbModules.IDBKeyRange;
