...
(function(window, Util){
	...
	Code.PhotoSwipe.CaptionClass = Code.PhotoSwipe.ElementClass.extend({
		...
		init: function(options){
			...
			this.contentEl = Util.DOM.createElement('div', { 'class': Code.PhotoSwipe.CaptionClass.CssClasses.content }, '<i class="topcoat-icon delete-icon white" style="float: right;cursor: pointer;"></i>');
